...
@section('conteudo')
    ...
    <div class="wrapper">
        <main>
            ...
            <section class="module content">
                <div class="container-parallax">
                    <h2>Sobre nós <i class="fa-solid fa-people-group"></i></h2>
            ...
            <section class="module content">
                ...
                <div class="container-parallax">
                    ...
                    <h5>LGPD</h5>
                    <p>A LGPD, ou Lei Geral de Proteção de Dados, é uma lei que protege suas informações pessoais. Ela diz que empresas precisam cuidar bem dos seus dados e usá-los de forma segura, além de pedir sua permissão antes de coletar ou usar esses dados. Nossa plataforma leva a LGPD muito a sério, o que significa que tomamos medidas rigorosas para garantir que seus dados estejam protegidos e que só serão usados da maneira que você autorizar. Seus dados são armazenados com segurança, e apenas pessoas autorizadas têm acesso a eles, mantendo sua privacidade e segurança em primeiro lugar.</p>
                </div>
            </section>
