...
@section('conteudo')
    ...
    @elseif(isset($eventos) || isset($artigos))
        ...
        <div class="container-mural">
            ...
            <div class="titulo-mural">
                @if (Auth::check())
                    @if (Auth::user()->nivel_de_acesso == 2)
                        <h1>Eventos <a href="{{ route('eventos_adicionar.mostrar') }}" class="icones-padrao"><i
                                    class="fa-regular fa-calendar-plus"></i></a></h1>
                    @else
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card mb-3" style="max-width: 500px;">
                            ...
                            @if (isset($evento->imagem))
                                <div class="col-md-4">
                                    <img src=base href="{{ asset('$evento->imagem') }}" width="100"
                            ...
                            <div class="col-md-auto">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><small class="text-body-secondary"><a
                                                ...
                                                target="_blank">{{ $evento->link_evento }}</a></small></p>
                                    ...
                                    @if (Auth::check())
                                        @if (Auth::user()->nivel_de_acesso == 2)
                                            <div class="icones_mural">
                                                ...
                                                <div class="popup-wrapper">
                                                    <div class="popup">
                                                        <div class="popup-content">
                                                            <h2>Confirmação</h2>
                                                            <p>Você tem certeza que deseja excluir permanentemente este
                                                                evento?</p>
                                                            <button class="popup-close">Cancelar</button>
                                                            <a href="{{ route('eventos.excluir', ['id' => $evento->id]) }}"
                                                                title="{{ $evento->id }}">
                                                                <button class="btn-confirma"
                                                                    onclick="confirmAndRedirect('{{ route('eventos.excluir', ['id' => $evento->id]) }}')">
                                                                    Confirmar </button>
                                                            </a>
                                                ...
                                                <a href="{{ route('eventos_editar.mostrar', ['id' => $evento->id]) }}"
            ...
            <div class="titulo-mural">
                @if (Auth::check())
                    @if (Auth::user()->nivel_de_acesso == 2)
                        <h1>Artigos <a href="{{ route('artigos_adicionar.processar') }}" class="icones-padrao"><i
                                    class="fa-solid fa-newspaper"></i></a></h1>
                    @else
            ...
            @foreach ($artigos as $publi)
                ...
                <div class="card artigo">
                    <div class="card-body">
                        ...
                        @if (Auth::check())
                            @if (Auth::user()->nivel_de_acesso == 2)
                                <div class="icones_mural">
                                    ...
                                    <div class="popup-wrapper">
                                        <div class="popup">
                                            <div class="popup-content">
                                                ...
                                                <button class="popup-close">Cancelar</button>
                                                <a href="{{ route('artigos.excluir', ['id' => $publi->id]) }}"
                                                    title="{{ $publi->id }}">
                                                    <button class="btn-confirma"
                                                        onclick="confirmAndRedirect('{{ route('artigos.excluir', ['id' => $publi->id]) }}')">
                                                        Confirmar </button>
                                                </a>
                                    ...
                                    <a href="{{ route('artigos_editar.mostrar', ['id' => $publi->id]) }}"><i
                                            class="fa-solid fa-pen-to-square"></i></a>
                                </div>
                            @endif
                        @endif
                        ...
                        <p class="card-text"><small class="text-body-secondary"><a href="{{ $publi->link }}"
                                    target="_blank">{{ $publi->link }}</a></small></p>
                    </div>
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    popups.forEach(popup => {
                        popup.addEventListener('click', event => {
                            ...
                            const shouldClosePopup = classNames.some(className => className ===
                                classNameOfClickedElement);
