        ...
        @foreach($eventos as $evento)
          <div class="col-md-auto">
            <div class="card mb-3" style="max-width: 500px;">
              ...
              <div class="col-md-4">
                    <img src=base href="{{ \URL::to('$evento->imagem') }}"  width="100" class="img-fluid rounded-start">
              </div>
              ...
              <div class="col-md-8">
                ...
                <div class="icones_mural">
                  ...
                  {{-- <button class="delete" data-event-id="{{ $evento->id }}"><i class="fa-solid fa-delete-left"></i></button> --}}
            ...
            {{-- <form class="delete-event-form" action="{{ route('excluir-evento', ['id' => $evento->id]) }}" method="POST">
                          @csrf
                          @method('DELETE')
                          <input type="hidden" name="event_id" value="{{ $evento->id }}"> --}}
                        <button class="popup-close">Cancelar</button>  
                        <button class="btn-confirma delete-event" data-event-id="{{ $evento->id }}">Confirmar</button>
                      </div>
                    </div>
                  </div>
                </div>
