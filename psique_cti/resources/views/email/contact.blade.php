...
<div class="container-email" style="background-color:#fffbc5;padding: 2%;">
    <h1 class="assunto" style="font-size: 35px;"> 
    ...
    <img src="{{ asset('img/attention.png') }}" class="rounded mx-auto d-block" alt="Atenção">
    <h1 style="font-size: 50px;">Parece que algum aluno precisa de ajuda!</h1>
    <h2>Aluno:  {{ $user->email }}</h2>
    <p>Seu contato diz: {{ $user->content }}</p>
</div>
